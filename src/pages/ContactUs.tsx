        ...
        <div className="max-w-[723px] w-full flex flex-col gap-8">
          <div className="w-full flex flex-col gap-8 md:flex-row">
            <div className="flex-col flex w-full gap-y-2">
              ...
              <input
                ...
                className="h-[42px] w-full rounded-lg border border-[#DDD] bg-transparent font-groteska-regular text-sm text-primaryGray px-4 outline-none focus:outline-none"
              />
            </div>
            <div className="flex-col flex w-full gap-y-2">
              <label
          ...
          <div className="flex-col flex w-full gap-y-2">
            ...
            <textarea
              ...
              className=" px-4 py-[11px] min-h-[220px] w-full rounded-lg border border-[#DDD] bg-transparent font-groteska-regular text-sm text-primaryGray  outline-none focus:outline-none md:min-h-[226px]"
            />
          </div>
          <div className="flex items-center justify-center mt-4 md:mt-10">
                      <button
                          className="rounded-lg bg-primaryWhite w-full gap-[5px] text-primaryBlack font-groteska-bold text-base inline-flex items-center justify-center max-w-[360px] h-[44px]"
                          type="submit">
              Send Message
              <svg
